...
- All 25 migrations are applied. Hosted reference data contains 139,346 HMS addresses and 2,970 Icelandic place names; the database used about 94 MB at the last check.
...
- Customers and drivers receive their secure Vegstoð links through ordinary WhatsApp. Drivers use passwordless, one-time Supabase Auth links generated by the staff-authorized `driver-access-v1` Edge Function; SMTP is not an operational dependency.
