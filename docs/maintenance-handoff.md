...
- A separate real WhatsApp demonstration for Alli completed customer submission with two private photos, assignment to **Alli Dráttarbíll**, passwordless driver activation, and driver acceptance. It remains accepted for owner inspection and is documented in [`docs/alli-live-demo-2026-09-07.md`](alli-live-demo-2026-09-07.md). Together with the retained physical-phone audit dataset, the hosted dashboard now has seven providers and five active jobs.
